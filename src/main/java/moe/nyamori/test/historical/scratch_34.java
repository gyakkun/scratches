...
class scratch_34 {
    public static void main(String[] args) {
        scratch_34 s = new scratch_34();
        long timing = System.currentTimeMillis();
        TreeNode8 one = new TreeNode8(1);
        TreeNode8 twoL = new TreeNode8(2);
        TreeNode8 twoR = new TreeNode8(2);
        one.left = twoL;
        one.right = twoR;
//        System.err.println(s.isSymmetric(one));
    ...
    public boolean isValidBstHelper(TreeNode8 root, long lo, long hi) {
    ...
    public int minDiffInBST(TreeNode8 root) {
...
class DisjointSetUnion34 {

    Map<Integer, Integer> father;
    Map<Integer, Integer> rank;

    public DisjointSetUnion34() {
        father = new HashMap<>();
        rank = new HashMap<>();
    }
...
class TreeNode34 {
    ...
    TreeNode34(int val, TreeNode8 left, TreeNode8 right) {
        this.val = val;
        this.left = left;
        this.right = right;
    }
