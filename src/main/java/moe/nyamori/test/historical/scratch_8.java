...
//                }
    ...
    public List<List<Integer>> pathSum(TreeNode8 root, int sum) {
        List<TreeNode8> treeNodeList = new ArrayList<>();
    ...
    private void recursive(List<TreeNode8> tmpTreePath, int sum) {
    ...
    public int sumList(List<TreeNode8> l) {
        int result = 0;
        for (TreeNode8 i : l) {
            result += i.val;
        }
    ...
    public static void main(String[] args) {
        TreeNode8 n1 = new TreeNode8(-2);
        TreeNode8 n2 = new TreeNode8(-3);
        n1.right = n2;
        List<TreeNode8> l = new ArrayList<>();
        l.add(n1);
        l.add(n2);
        scratch_8 s = new scratch_8();
...
//        System.err.println(s.minDistance("zoologicoarchaeologist","zoogeologist"));
    ...
    public List<List<Integer>> levelOrder(TreeNode8 root) {
        ...
        Queue<TreeNode8> working = new LinkedList<>();
        working.offer(root);
