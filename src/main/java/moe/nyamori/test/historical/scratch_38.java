    ...
    public void insert(String word) {
        ...
        for (i = 0; i < word.length() - 1; i++) {
            ...
            if (former.val != word.charAt(i)) {
                former.sibling = new TrieNode38(word.charAt(i));
                former = former.sibling;
            }
            if (former.child == null) former.child = new TrieNode38();
            former = former.child;
        }
...
class TrieNode38 {
    ...
    public TrieNode38(Character c) {
        this.val = c;
        this.isEnd = false;
    }

    public TrieNode38 searchSibling(Character c) {
        TrieNode38 former = this;
    ...
    public TrieNode38 searchChildren(Character c) {
        TrieNode38 former = this;
