...
//        }));
    ...
    public int minimalSteps(String[] maze) {
        ...
        if (mSet.size() == 0) return minLenToTarget(start, end, m, n, directions, wSet, Integer.MAX_VALUE);
        ...
        // 双向BFS 处理点之间的最近距离
        long timing = System.currentTimeMillis();
        getPointToPointMinLen(directions, m, n, oSet, wSet, pointsArr, minLenToStoneCache);
        timing = System.currentTimeMillis() - timing;
        ...
        for (int i = 0; i < pointSet.size(); i++) {
            int finalStep = minLenToTarget(pointsArr[i], end, m, n, directions, wSet, Integer.MAX_VALUE);
    ...
    private void getPointToPointMinLen(int[][] directions, int m, int n, Set<Integer> oSet, Set<Integer> wSet, int[] pointsArr, int[][] minLenToStoneCache) {
        for (int i = 0; i < pointsArr.length; i++) {
            for (int j = i + 1; j < pointsArr.length; j++) {
                ...
                // 选一个石堆
                for (int stone : oSet) {
                    int fromI = minLenToTarget(pointsArr[i], stone, m, n, directions, wSet, minToStoneLen);
                    int fromJ = minLenToTarget(pointsArr[j], stone, m, n, directions, wSet, minToStoneLen);
    ...
    private int minLenToTarget(int from, int target, int m, int n, int[][] directions, Set<Integer> wSet, int curMin) {
